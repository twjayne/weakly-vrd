...
class BasicData(Dataset):
    def __init__(self, dataroot):
        ...
        test = scipy.io.loadmat(os.path.join(dataroot, 'test/annotated/pairs.mat'))['pairs'][0][0]
    ...
    def loadPredicate(self, index, mode='train'):
        ...
        if mode == 'train':
            rel_id = int(self.train_pairs['rel_id'][i][0])
            rel_cat = self.train_pairs['rel_cat'][rel_id-1][0]-1
...
#     # print('testing...len')
#     # print('test set length:', len(test['rel_id']))
#     # print('traing set length:', len(myData))
#     # print('testing...predicate')
#     # pred = myData.loadPredicate(1)
#     # print(myData.loadPredicate(1))
#     # subject = myData.loadSubject(1)
#     # print(f'testing...subject\n{subject}')
#     # obj = myData.loadObject(1)
#     # print(f'testing...object\n{obj}')
#     # triplet = myData.loadTriplet(1)
#     # print(f'triplets:......<{triplet[0]},{triplet[1]},{triplet[2]}>')
#     # print('testing...spatial')
#     # spatial = myData.loadSpatial(1)
#     # shape = spatial.shape
#     # print(f'{shape}')
